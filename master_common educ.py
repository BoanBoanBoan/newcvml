...
# Example usage
root_directories = {
    'Master Degree Specialist': "generator_degree/common_master_degree_specialist_pdfs",
    'Common Master Degree Specialist': "generator_degree/master_degree_specialist_pdfs",
}
